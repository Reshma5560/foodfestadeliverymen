...
class PastOrderModel {
  ...
  factory PastOrderModel.fromJson(Map<String, dynamic> json) => PastOrderModel(
        status: json["status"],
        data:
            json["data"] == null ? null : PastOrderData.fromJson(json["data"]),
      );
}

class PastOrderData {
  final int? currentPage;
  final List<PastOrderDatum>? data;
  ...
  factory PastOrderData.fromJson(Map<String, dynamic> json) => PastOrderData(
        currentPage: json["current_page"],
        data: json["data"] == null
            ? []
            : List<PastOrderDatum>.from(
                json["data"]!.map((x) => PastOrderDatum.fromJson(x))),
...
class PastOrderDatum {
  ...
  factory PastOrderDatum.fromJson(Map<String, dynamic> json) => PastOrderDatum(
        id: json["id"],
